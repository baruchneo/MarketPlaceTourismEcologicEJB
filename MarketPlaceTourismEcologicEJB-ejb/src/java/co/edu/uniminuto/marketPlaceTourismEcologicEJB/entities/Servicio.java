...
@NamedQueries({
    ...
    @NamedQuery(name = "Servicio.findByCode", query = "SELECT s FROM Servicio s WHERE s.code = :code"),
...
public class Servicio implements Serializable {
    ...
    public Servicio(Integer idServicio, String nombre, String code, String descripcion, String ubicacion, int disponibilidad, double costo) {
        this.idServicio = idServicio;
        this.nombre = nombre;
        this.code = code;
    ...
    public String toString() {
        return "co.edu.uniminuto.marketPlaceTourismEcologicEJB.entities.Servicio[ idServicio=" + idServicio + " ]";
    }
